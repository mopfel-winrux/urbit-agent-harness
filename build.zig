...
const dependencies = [_]RepoImport{
    .{
        .name = "threads-js",
        .url = "https://github.com/dozreg-toplud/threads-js",
        .commit = "f3530908124d3a6c2f2ef8932ab4937c242b8d1f",
        .prefix = "desk",
        .paths = &.{
            "lib/channel-json.hoon",
            "lib/cite-json.hoon",
            "lib/groups-json.hoon",
            "lib/mop-extensions.hoon",
            "lib/story-json.hoon",
    ...
    .{
        ...
        .commit = "5a6129d562953fb1a880485ba0ac28f623c82362",
        .prefix = "desk",
        .paths = &.{
            "lib/test-agent.hoon",
        },
