...
const copy = {
  ...
  tlon: ['Tlon', 'Read and send messages, manage contacts, groups, permissions and Notes, and upload files as this ship. Includes editing and deletion beyond the current conversation.'],
