...
export default function Sidebar({ chats, current, onSelect, onNew, onRename, onDelete, settings, onSettings, onSessionSettings, tlon, onTlon, corpus, onCorpus, work, onWorkspace }) {
