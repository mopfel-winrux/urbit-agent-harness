...
++  test-notes-store-upgrade-preserves-native-identities
  ...
  (expect-eq !>([%29 *state:renew *state:hosted %27 (restore-workspace:storage workspace.saved) *state:wc *state:pc *state:ws workspace-notes.saved legacy-workspace.saved runtime]) !>((load:storage !>(saved))))
++  test-project-client-upgrade-does-not-grant-access-or-change-work
  ...
  (expect-eq !>([%29 *state:renew *state:hosted %27 (restore-workspace:storage workspace.saved) *state:wc *state:pc workspace-search.saved workspace-notes.saved legacy-workspace.saved runtime]) !>((load:storage !>(saved))))
++  test-work-control-migration-retains-pending-notes-and-the-entire-envelope
  ...
  (expect-eq !>([%29 *state:renew *state:hosted %27 (restore-workspace:storage workspace.saved) *state:wc project-clients.saved workspace-search.saved workspace-notes.saved legacy-workspace.saved runtime]) !>((load:storage !>(saved))))
