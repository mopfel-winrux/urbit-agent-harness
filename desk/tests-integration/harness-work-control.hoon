...
++  test-human-help-and-empty-argument-reads-need-no-model
  ...
  =/  after  !<(state-27 ~(on-save +.out bowl))
  =/  rows
...
++  test-owner-command-prepares-then-confirms-once-without-model-work
  ...
  =/  before  !<(state-27 ~(on-save +.prepared bowl))
...
++  test-reviewed-reply-reload-retains-one-literal-effect-and-exclusive-claim
  ...
  =/  queued  !<(state-27 ~(on-save +.sent bowl))
  ...
  =/  restored  !<(state-27 ~(on-save +.reloaded bowl))
  ...
  =/  once  !<(state-27 ~(on-save +.duplicate bowl))
  ...
  =/  ready  !<(state-27 ~(on-save +.more bowl))
  ...
  =/  withheld  !<(state-27 ~(on-save +.denied bowl))
  ...
  =/  claimed  !<(state-27 ~(on-save +.claim bowl))
