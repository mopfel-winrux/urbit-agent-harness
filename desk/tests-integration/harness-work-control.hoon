...
++  test-human-help-and-empty-argument-reads-need-no-model
  ...
  =/  after  !<(state-30 ~(on-save +.out bowl))
  =/  rows
...
++  test-owner-command-prepares-then-confirms-once-without-model-work
  ...
  =/  before  !<(state-30 ~(on-save +.prepared bowl))
...
++  test-reviewed-reply-reload-retains-one-literal-effect-and-exclusive-claim
  ...
  =/  queued  !<(state-30 ~(on-save +.sent bowl))
  ...
  =/  restored  !<(state-30 ~(on-save +.reloaded bowl))
  ...
  =/  once  !<(state-30 ~(on-save +.duplicate bowl))
  ...
  =/  ready  !<(state-30 ~(on-save +.more bowl))
  ...
  =/  withheld  !<(state-30 ~(on-save +.denied bowl))
  ...
  =/  claimed  !<(state-30 ~(on-save +.claim bowl))
