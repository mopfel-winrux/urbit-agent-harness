...
++  owner-model-provision
  ...
  =/  loaded  (~(on-load head bowl) !>(*state-0))
  ...
  =/  saved  !<(state-0 ~(on-save +.selected bowl))
  ...
  =/  retained  !<(state-0 ~(on-save +.provisioned bowl))
  ;:  weld
...
++  cleanup-reload
  ...
  =/  after  !<(state-0 ~(on-save +.cleared bowl))
  ...
  =/  late-state  !<(state-0 ~(on-save +.late bowl))
  ;:  weld
...
++  provision-reload
  ...
  =/  next  !<(state-0 ~(on-save +.applied bowl))
  ...
  =/  after  !<(state-0 ~(on-save +.repeated bowl))
  ...
  =/  owner-first  !<(state-0 ~(on-save +.provisioned bowl))
  ;:  weld
...
++  xai-login
  ...
  =/  saved  !<(state-0 ~(on-save +.verified bowl))
  ...
  =/  pending  !<(state-0 ~(on-save +.requested bowl))
  ...
  =/  after  !<(state-0 ~(on-save +.renewed bowl))
  =/  requests
    %+  murn  -.renewed
    |=  c=card:agent:gall
